...
void main() {
  ...
  d = min(d, mod((uv.x + uv.y) * 7., 0.75));
  d = min(d, 1. - (uv.x + uv.y));
  
  vec2 cv = uv - vec2(0.55, 0.1);
  
  float r0 = sdOrientedBox(cv, vec2(0.1, 0.1), vec2(-0.1, -0.1), .01);
  
  d = max(d, 1.0-smoothstep(0.0, 0.01, r0));
  
  float r1 = sdOrientedBox(cv, vec2(-0.1, 0.3), vec2(0.1, 0.1), .01);
  
  d = max(d, 1.0-smoothstep(0.0, 0.01, r1));
  
  float r2 = sdOrientedBox(cv, vec2(-0.1, 0.3), vec2(-0.23, 0.165), .01);
  
  d = max(d, 1.0-smoothstep(0.0, 0.01, r2));
  
  float r3 = sdOrientedBox(cv, vec2(-0.23, 0.165), vec2(-0.07, 0.01), .01);
  
  d = max(d, 1.0-smoothstep(0.0, 0.01, r3));
  
  float r4 = sdOrientedBox(cv, vec2(0.02, 0.1), vec2(-0.07, 0.01), .01);
  
  d = max(d, 1.0-smoothstep(0.0, 0.01, r4));
  
  float r5 = sdOrientedBox(cv, vec2(0.02, 0.1), vec2(-0.1, 0.22), .01);
  
  d = max(d, 1.0-smoothstep(0.0, 0.01, r5));
  
  float r6 = sdOrientedBox(cv, vec2(-0.145, 0.17), vec2(-0.1, 0.22), .01);
  
  d = max(d, 1.0-smoothstep(0.0, 0.01, r6));
  
  float r7 = sdOrientedBox(cv, vec2(-0.145, 0.17), vec2(-0.07, 0.1), .01);
